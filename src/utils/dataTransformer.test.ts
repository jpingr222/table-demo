...
const testQuestions: { data: SurveySchema[] } = {
  data: [
    {
      qid: 'QID16',
      qname: 'S0',
...
describe('dataProcessor', () => {
  describe('getPureQuestions', () => {
    it('should filter out non question data and reformat', () => {
      const actual = getPureQuestions(testQuestions.data);
  ...
  describe('getGeneralQuestions', () => {
    it('should return first 10 questions', () => {
      ...
      const actual = getGeneralQuestions(moreQuestions.data);
    ...
    it('should return all questions when less than 10 questions', () => {
      const actual = getGeneralQuestions(testQuestions.data);
  ...
  describe('getProcessedResults', () => {
    it('should reformat results', () => {
      const actual = getProcessedResults(testResults.data);
